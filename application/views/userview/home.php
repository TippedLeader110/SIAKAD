	<div class="row">
		...
		<div class="row">
			<div class="col-md-8">
				<div class="container" style="background: white;border-width: 1px;border-color: #d6d6c2;padding-bottom: 50px;">
					...
					<p style="padding: 10px 10px 10px 10px;">Sistem Informasi Akademin (SIAKAD) adalah sebuah aplikasi yang dibuat untuk Murid/i yang dapat diakases oleh orangtua Murid/i dan guru/wali kelas agar dapat mengakses informasi seputar lingkungan akademik secara online dimana dan kapan saja.</p>
					<p style="padding-top: -15px; padding-left: 10px;">
						Murid dapat mengakses informasi data diri yang sudah terdaftar di sekolah dan juga informasi mengenai pengembangan prestasi akademkinya di sekolah dan orang tua Murid dapat memantau perkembangan anaknya di sekolah.
					</p>
				</div>
			</div>	
			<div class="col-md-4">
				<div class="row">
					<div class="container" style="background: #2F669F;border-width: 1px;border-color: #d6d6c2;margin-right: 16px; padding: 5px 5px 5px 5px;">
							...
							<table border="0" width="330">
								...
								<tr>
									<td colspan="2" style="padding-left: 35px;">
										<h6 style="color: white">Klik salah satu gambar untuk masuk </h6>
									</td>
								</tr>
							</table>						
		...
		<div class="row">
			<div class="container-fluid">
				<div style="background-color: #2F669F; color: #ebebe0; padding: 15px 25px 10px 20px; margin-top: 49px;">
