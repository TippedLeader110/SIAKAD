	...
	<div>
		<table border="2" style="width:800px; text-align: center;">
			...
			<tr>
				<td>1.</td>
				<td>Geografi</td>				
				<td><?php echo $vgeografi->tugas_1 ?></td>
				<td><?php echo $vgeografi->tugas_2 ?></td>
				<td><?php echo $vgeografi->tugas_3 ?></td>
			</tr>
			<tr>
				<td>2.</td>
				<td>Sejarah</td>				
				<td><?php echo $vsejarah->tugas_1 ?></td>
				<td><?php echo $vsejarah->tugas_2 ?></td>
				<td><?php echo $vsejarah->tugas_3 ?></td>
			</tr>
			<tr>
				<td>3.</td>
				<td>Sosiologi</td>				
				<td><?php echo $vsosiologi->tugas_1 ?></td>
				<td><?php echo $vsosiologi->tugas_2 ?></td>
				<td><?php echo $vsosiologi->tugas_3 ?></td>
			</tr>
			<tr>
				<td>4.</td>
				<td>Ekonomi</td>				
				<td><?php echo $vekonomi_p->tugas_1 ?></td>
				<td><?php echo $vekonomi_p->tugas_2 ?></td>
				<td><?php echo $vekonomi_p->tugas_3 ?></td>
			</tr>
		</table>
	</div>
</div>
