				...
				<div class="row">
					<table  class="table table-bordered table-stripped" style="margin-left: 30px;background: white;margin-right: 30px;text-align: center;">
						...
						<tr>
							...
							<td><form method="post" action="<?php echo base_url()?>Wali/tampil"><input type="text" hidden name="id" value="<?php echo $v->nis ?>"><button type="submit" class="btn btn-info">Input Nilai Wali</button></form></td>
						</tr>
							<?php endforeach ?>
					</table>
				</div>
