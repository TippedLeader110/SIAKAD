	...
	<div>
		<table border="2" style="width:800px; text-align: center;">
			...
			<tr>
				<td>1.</td>
				<td>Geografi</td>
				<td><?php echo $vgeografi->uts ?></td>
			</tr>
			<tr>
				<td>2.</td>
				<td>Sejarah</td>
				<td><?php echo $vsejarah->uts ?></td>
			</tr>
			<tr>
				<td>3.</td>
				<td>Sosiologi</td>
	...
	<div>
		<table border="2" style="width:800px; text-align: center;">
			<tr>
				...
				<td><?php echo $vsosiologi+$vekonomi_p+$vsejarah+$vgeografi+$vb_arab->uts+$vmatematika->uts+$vsejarah_indo->uts+$vb_ing->uts+$vseni_budaya->uts+$vpenjas->uts+$vprakarya_kewirausahaan->uts+$vpkn->uts+$vb_indo->uts+$vquran_hadis->uts+$vakidah_akhlak->uts+$vfikih->uts+$vski->uts ?></td>
			</tr>
		</table>
	</div>
</div>
