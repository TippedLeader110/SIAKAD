					...
					<table style="min-width: 500px;">
						<tr>
							...
							<td>
								...
								<option value="jurusan">-Pilih Ekstrakulikuler-</option>
								<option value="jurusan">Marching Band</option>
								<option value="jurusan">Paskibra</option>
								<option value="jurusan">Pramuka</option>
								</select> 
							</td>
						</tr>
						<tr>
