<div class="container" style="border-width:0px; background-color:#DCDDE1; padding-top: 10px; padding-bottom: 10px;">
  ...
  'success'
								...
								<?php $_SESSION['do']=''; ?>
							<?php endif ?>
								<td><form method="post" action="<?php echo base_url() ?>Absen/SikaEks"><input type="text" hidden name="tent" value="nama">
							...
							<form method='post' action="<?php echo base_url() ?>Wali/SikaEks">
				...
				<div class="row">
					<table  class="table table-bordered table-stripped" style="margin-left: 30px;background: white;margin-right: 30px;text-align: center;">
						...
						<tr>
							...
							<td><form method="post" action="<?php echo base_url()?>Wali/tampil2"><input type="text" hidden name="id" value="<?php echo $v->nis ?>"><button type="submit" class="btn btn-info">Input Nilai Wali</button></form></td>
						</tr>
							<?php endforeach ?>
					</table>
				</div>
