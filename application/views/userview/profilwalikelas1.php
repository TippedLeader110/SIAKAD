...
<div class="row">
	<div class="col-md-8">
		...
		<div class="row">
				<div class="col-md-4">
					<div class="container" style="background-color:#8DB3DA; border-width: 0px; color:white; font-weight: 500;width: 200px; margin-top: 30px; font-size: 25px;">
						<center><a href="http://localhost/SIAKAD/Profil/walikelas" style="text-decoration: none;">Data Sekolah</a></center>
					</div>
				</div>
				<div class="col-md-4">
					<div class="container" style="background-color:#2F669F; border-width: 0px;  width: 200px;font-weight: 500;margin-left: 10px;  margin-top: 30px; margin-bottom: 15px; font-size: 25px;">
						<center><a href="http://localhost/SIAKAD/Profil/walikelas1" style="color:white; text-decoration: none;">Data Pribadi</a></center>
					</div>
				</div>
		</div>
		<div class="row">
