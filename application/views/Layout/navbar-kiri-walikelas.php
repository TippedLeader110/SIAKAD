        ...
        <div class="field-menu scrollable">
          <div class="row">
              ...
              <a href="<?php echo base_url() ?>Absen/walikelas">
                ...
                <span class="kotak"></span>
                <span class="triangle"></span>
                <h5 style="color: black; text-align: left;" class=<?php echo $absen?>>Input Absensi</h5>
               </div>
              </a>
              <a href="<?php echo base_url() ?>absen/lihat">
                 <div style="width: 200px; height: 33px; background: #ebebe0; margin-left: 50px; margin-top: 10px; margin-bottom: 5px; padding: 5px 5px 5px 20px;" class="row">
                <span class="kotak"></span>
                <span class="triangle"></span>
                <h5 style="color: black; text-align: left;" class=<?php echo $ab?>>Daftar Absensi</h5>
               </div>
              </a>
              <a href="<?php echo base_url() ?>Daftar/siswa">
                ...
                <span class="kotak"></span>
                <span class="triangle"></span>
                <h5 style="color: black; text-align: left;" class=<?php echo $ini?>>Daftar Murid</h5>
               </div>
              </a>
              ...
              <a href="<?php echo base_url() ?>ubahsandi/guru">
                ...
                <span class="kotak"></span>
                <span class="triangle"></span>
                <h5 style="color: black; text-align: left;" class=<?php echo $sandi?>>Ubah Kata Sandi</h5>
               </div>
              </a>
          </div>
        </div>
